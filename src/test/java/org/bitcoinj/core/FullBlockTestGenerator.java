...
public class FullBlockTestGenerator {
    ...
    Map<Sha256Hash, Integer> blockToHeightMap = new HashMap<Sha256Hash, Integer>();

    Map<Sha256Hash, Block> hashHeaderMap = new HashMap<Sha256Hash, Block>();
    Map<Sha256Hash, Sha256Hash> coinbaseBlockMap = new HashMap<Sha256Hash, Sha256Hash>();
    ...
    public RuleList getBlocksToTest(boolean runBarelyExpensiveTests, boolean runExpensiveTests, File blockStorageFile) throws ScriptException, ProtocolException, IOException {
        ...
        blocks.add(new BlockAndValidity(this, chainHead, true, false, chainHead.getHash(), 1, "Initial Block"));
        ...
        for (int i = 1; i < params.getSpendableCoinbaseDepth(); i++) {
            ...
            chainHeadHeight++;
            blocks.add(new BlockAndValidity(this, chainHead, true, false, chainHead.getHash(), i + 1, "Initial Block chain output generation"));
            spendableOutputs.offer(new TransactionOutPointWithValue(
                    new TransactionOutPoint(params, 0, chainHead.getTransactions().get(0).getHash()),
                    FIFTY_COINS, chainHead.getTransactions().get(0).getOutputs().get(0).getScriptPubKey()));
        }
        ...
        blocks.add(new BlockAndValidity(this, b1, true, false, b1.getHash(), chainHeadHeight + 1, "b1"));
        ...
        blocks.add(new BlockAndValidity(this, b2, true, false, b2.getHash(), chainHeadHeight + 2, "b2"));
        ...
        blocks.add(new BlockAndValidity(this, b3, true, false, b2.getHash(), chainHeadHeight + 2, "b3"));
        ...
        blocks.add(new BlockAndValidity(this, b4, true, false, b4.getHash(), chainHeadHeight + 3, "b4"));

        // ... and back to the first chain.
        NewBlock b5 = createNextBlock(b2, chainHeadHeight + 3, out2, null);
        blocks.add(new BlockAndValidity(this, b5, true, false, b4.getHash(), chainHeadHeight + 3, "b5"));
        ...
        blocks.add(new BlockAndValidity(this, b6, true, false, b6.getHash(), chainHeadHeight + 4, "b6"));
        //
        ...
        blocks.add(new BlockAndValidity(this, b7, true, false, b6.getHash(), chainHeadHeight + 4, "b7"));

        TransactionOutPointWithValue out4 = spendableOutputs.poll();

        NewBlock b8 = createNextBlock(b7, chainHeadHeight + 6, out4, null);
        blocks.add(new BlockAndValidity(this, b8, false, true, b6.getHash(), chainHeadHeight + 4, "b8"));
        ...
        blocks.add(new BlockAndValidity(this, b9, false, true, b6.getHash(), chainHeadHeight + 4, "b9"));
        ...
        blocks.add(new BlockAndValidity(this, b10, true, false, b6.getHash(), chainHeadHeight + 4, "b10"));

        NewBlock b11 = createNextBlock(b10, chainHeadHeight + 5, out4, SATOSHI);
        blocks.add(new BlockAndValidity(this, b11, false, true, b6.getHash(), chainHeadHeight + 4, "b11"));
        ...
        blocks.add(new BlockAndValidity(this, b13, false, false, b6.getHash(), chainHeadHeight + 4, "b13"));
        ...
        blocks.add(new BlockAndValidity(this, b14, false, false, b6.getHash(), chainHeadHeight + 4, "b14"));
        // Make sure we dont die if an orphan gets added twice
        blocks.add(new BlockAndValidity(this, b14, false, false, b6.getHash(), chainHeadHeight + 4, "b14"));

        blocks.add(new BlockAndValidity(this, b12, false, true, b13.getHash(), chainHeadHeight + 5, "b12"));
        ...
        blocks.add(new BlockAndValidity(this, b15, true, false, b15.getHash(), chainHeadHeight + 6, "b15"));
        ...
        blocks.add(new BlockAndValidity(this, b16, false, true, b15.getHash(), chainHeadHeight + 6, "b16"));
        ...
        b17.solve();
        blocks.add(new BlockAndValidity(this, b17, false, true, b15.getHash(), chainHeadHeight + 6, "b17"));
        ...
        b18.solve();
        blocks.add(new BlockAndValidity(this, b18, true, false, b15.getHash(), chainHeadHeight + 6, "b17"));

        NewBlock b19 = createNextBlock(b18, chainHeadHeight + 7, out6, null);
        blocks.add(new BlockAndValidity(this, b19, false, true, b15.getHash(), chainHeadHeight + 6, "b19"));
        ...
        blocks.add(new BlockAndValidity(this, b20, false, true, b15.getHash(), chainHeadHeight + 6, "b20"));
        ...
        blocks.add(new BlockAndValidity(this, b21.block, true, false, b15.getHash(), chainHeadHeight + 6, "b21"));
        NewBlock b22 = createNextBlock(b21, chainHeadHeight + 7, out5, null);
        blocks.add(new BlockAndValidity(this, b22.block, false, true, b15.getHash(), chainHeadHeight + 6, "b22"));
        ...
        blocks.add(new BlockAndValidity(this, b23, true, false, b23.getHash(), chainHeadHeight + 7, "b23"));
        ...
        blocks.add(new BlockAndValidity(this, b24, false, true, b23.getHash(), chainHeadHeight + 7, "b24"));
        ...
        blocks.add(new BlockAndValidity(this, b25, false, false, b23.getHash(), chainHeadHeight + 7, "b25"));
        ...
        b26.solve();
        blocks.add(new BlockAndValidity(this, b26, false, true, b23.getHash(), chainHeadHeight + 7, "b26"));

        // Extend the b26 chain to make sure bitcoind isn't accepting b26
        NewBlock b27 = createNextBlock(b26, chainHeadHeight + 8, out7, null);
        blocks.add(new BlockAndValidity(this, b27, false, false, b23.getHash(), chainHeadHeight + 7, "b27"));
        ...
        b28.solve();
        blocks.add(new BlockAndValidity(this, b28, false, true, b23.getHash(), chainHeadHeight + 7, "b28"));

        // Extend the b28 chain to make sure bitcoind isn't accepting b28
        NewBlock b29 = createNextBlock(b28, chainHeadHeight + 8, out7, null);
        blocks.add(new BlockAndValidity(this, b29, false, false, b23.getHash(), chainHeadHeight + 7, "b29"));
        ...
        b30.solve();
        blocks.add(new BlockAndValidity(this, b30, true, false, b30.getHash(), chainHeadHeight + 8, "b30"));
        ...
        blocks.add(new BlockAndValidity(this, b31, true, false, b31.getHash(), chainHeadHeight + 9, "b31"));
        ...
        b32.solve();
        blocks.add(new BlockAndValidity(this, b32, false, true, b31.getHash(), chainHeadHeight + 9, "b32"));
        ...
        blocks.add(new BlockAndValidity(this, b33, true, false, b33.getHash(), chainHeadHeight + 10, "b33"));
        ...
        b34.solve();
        blocks.add(new BlockAndValidity(this, b34, false, true, b33.getHash(), chainHeadHeight + 10, "b34"));
        ...
        blocks.add(new BlockAndValidity(this, b35, true, false, b35.getHash(), chainHeadHeight + 11, "b35"));
        ...
        blocks.add(new BlockAndValidity(this, b36, false, true, b35.getHash(), chainHeadHeight + 11, "b36"));
        ...
        b37.solve();
        blocks.add(new BlockAndValidity(this, b37, false, true, b35.getHash(), chainHeadHeight + 11, "b37"));
        ...
        b38.solve();
        blocks.add(new BlockAndValidity(this, b38, false, true, b35.getHash(), chainHeadHeight + 11, "b38"));
        ...
        b39.solve();
        blocks.add(new BlockAndValidity(this, b39, true, false, b39.getHash(), chainHeadHeight + 12, "b39"));
        ...
        b40.solve();
        blocks.add(new BlockAndValidity(this, b40, false, true, b39.getHash(), chainHeadHeight + 12, "b40"));
        ...
        if (runBarelyExpensiveTests) {
            ...
            b41.solve();
            blocks.add(new BlockAndValidity(this, b41, true, false, b41.getHash(), chainHeadHeight + 13, "b41"));
        }
        ...
        blocks.add(new BlockAndValidity(this, b42, true, false, b41 == null ? b42.getHash() : b41.getHash(), chainHeadHeight + 13, "b42"));
        ...
        blocks.add(new BlockAndValidity(this, b43, true, false, b43.getHash(), chainHeadHeight + 14, "b43"));
        ...
        b44.solve();
        blocks.add(new BlockAndValidity(this, b44, true, false, b44.getHash(), chainHeadHeight + 15, "b44"));
        ...
        b45.solve();
        blocks.add(new BlockAndValidity(this, b45, false, true, b44.getHash(), chainHeadHeight + 15, "b45"));
        ...
        b46.solve();
        blocks.add(new BlockAndValidity(this, b46, false, true, b44.getHash(), chainHeadHeight + 15, "b46"));
        ...
        blocks.add(new BlockAndValidity(this, b47, false, true, b44.getHash(), chainHeadHeight + 15, "b47"));
        ...
        b48.solve();
        blocks.add(new BlockAndValidity(this, b48, false, true, b44.getHash(), chainHeadHeight + 15, "b48"));
        ...
        b49.solve();
        blocks.add(new BlockAndValidity(this, b49, false, true, b44.getHash(), chainHeadHeight + 15, "b49"));
        ...
        b50.solve();
        blocks.add(new BlockAndValidity(this, b50, false, true, b44.getHash(), chainHeadHeight + 15, "b50"));
        ...
        b51.solve();
        blocks.add(new BlockAndValidity(this, b51, false, true, b44.getHash(), chainHeadHeight + 15, "b51"));
        ...
        b52.solve();
        blocks.add(new BlockAndValidity(this, b52, false, true, b44.getHash(), chainHeadHeight + 15, "b52"));
        ...
        blocks.add(new BlockAndValidity(this, b53, true, false, b44.getHash(), chainHeadHeight + 15, "b53"));
        ...
        b54.solve();
        blocks.add(new BlockAndValidity(this, b54, false, true, b44.getHash(), chainHeadHeight + 15, "b54"));
        ...
        b55.solve();
        blocks.add(new BlockAndValidity(this, b55, true, false, b55.getHash(), chainHeadHeight + 16, "b55"));
        ...
        blocks.add(new BlockAndValidity(this, b56, false, true, b55.getHash(), chainHeadHeight + 16, "b56"));
        ...
        blocks.add(new BlockAndValidity(this, b56p2, false, true, b55.getHash(), chainHeadHeight + 16, "b56p2"));
        blocks.add(new BlockAndValidity(this, b57p2, true, false, b57p2.getHash(), chainHeadHeight + 17, "b57p2"));

        blocks.add(new BlockAndValidity(this, b57, true, false, b57p2.getHash(), chainHeadHeight + 17, "b57"));
        ...
        b58.solve();
        blocks.add(new BlockAndValidity(this, b58, false, true, b57p2.getHash(), chainHeadHeight + 17, "b58"));
        ...
        b59.solve();
        blocks.add(new BlockAndValidity(this, b59, false, true, b57p2.getHash(), chainHeadHeight + 17, "b59"));

        NewBlock b60 = createNextBlock(b57, chainHeadHeight + 18, out17, null);
        blocks.add(new BlockAndValidity(this, b60, true, false, b60.getHash(), chainHeadHeight + 18, "b60"));
        ...
        b61.solve();
        // blocks.add(new BlockAndValidity(this, b61, false, true, b60.getHash(), chainHeadHeight + 18, "b61"));
    ...
    BlockAndValidity(this,b62, false,true,b60.getHash(),chainHeadHeight
    ...
    +18,"b62"));
        ...
        BlockAndValidity(this, b63, false,true,b60.getHash(),chainHeadHeight +18,"b63"));
        ...
        blocks.add(new BlockAndValidity(this, b64, true, false, b64.getHash(), chainHeadHeight + 19, "b64"));
        ...
        b65.solve();
        blocks.add(new BlockAndValidity(this, b65, true, false, b65.getHash(), chainHeadHeight + 20, "b65"));
        ...
        b66.solve();
        blocks.add(new BlockAndValidity(this, b66, false, true, b65.getHash(), chainHeadHeight + 20, "b66"));
        ...
        b67.solve();
        blocks.add(new BlockAndValidity(this, b67, false, true, b65.getHash(), chainHeadHeight + 20, "b67"));
        ...
        b68.solve();
        blocks.add(new BlockAndValidity(this, b68, false, true, b65.getHash(), chainHeadHeight + 20, "b68"));
        ...
        b69.solve();
        blocks.add(new BlockAndValidity(this, b69, true, false, b69.getHash(), chainHeadHeight + 21, "b69"));
        ...
        b70.solve();
        blocks.add(new BlockAndValidity(this, b70, false, true, b69.getHash(), chainHeadHeight + 21, "b70"));
        ...
        blocks.add(new BlockAndValidity(this, b71, false, true, b69.getHash(), chainHeadHeight + 21, "b71"));
        blocks.add(new BlockAndValidity(this, b72, true, false, b72.getHash(), chainHeadHeight + 22, "b72"));
        ...
        b73.solve();
        blocks.add(new BlockAndValidity(this, b73, false, true, b72.getHash(), chainHeadHeight + 22, "b73"));
        ...
        b74.solve();
        blocks.add(new BlockAndValidity(this, b74, false, true, b72.getHash(), chainHeadHeight + 22, "b74"));
        ...
        b75.solve();
        blocks.add(new BlockAndValidity(this, b75, true, false, b75.getHash(), chainHeadHeight + 23, "b75"));
        ...
        b76.solve();
        blocks.add(new BlockAndValidity(this, b76, true, false, b76.getHash(), chainHeadHeight + 24, "b76"));
        ...
        blocks.add(new BlockAndValidity(this, b77, true, false, b77.getHash(), chainHeadHeight + 25, "b77"));
        ...
        b78.solve();
        blocks.add(new BlockAndValidity(this, b78, true, false, b78.getHash(), chainHeadHeight + 26, "b78"));
        ...
        b79.solve();
        blocks.add(new BlockAndValidity(this, b79, true, false, b79.getHash(), chainHeadHeight + 27, "b79"));
        ...
        blocks.add(new BlockAndValidity(this, b80, true, false, b79.getHash(), chainHeadHeight + 27, "b80"));
        spendableOutputs.offer(b80.getCoinbaseOutput());

        NewBlock b81 = createNextBlock(b80, chainHeadHeight + 27, out26, null);
        blocks.add(new BlockAndValidity(this, b81, true, false, b79.getHash(), chainHeadHeight + 27, "b81"));
        spendableOutputs.offer(b81.getCoinbaseOutput());

        NewBlock b82 = createNextBlock(b81, chainHeadHeight + 28, out27, null);
        blocks.add(new BlockAndValidity(this, b82, true, false, b82.getHash(), chainHeadHeight + 28, "b82"));
        ...
        b83.solve();
        blocks.add(new BlockAndValidity(this, b83, true, false, b83.getHash(), chainHeadHeight + 29, "b83"));
        ...
        b84.solve();
        blocks.add(new BlockAndValidity(this, b84, true, false, b84.getHash(), chainHeadHeight + 30, "b84"));
        spendableOutputs.offer(b84.getCoinbaseOutput());

        NewBlock b85 = createNextBlock(b83, chainHeadHeight + 30, out29, null);
        blocks.add(new BlockAndValidity(this, b85, true, false, b84.getHash(), chainHeadHeight + 30, "b85"));

        NewBlock b86 = createNextBlock(b85, chainHeadHeight + 31, out30, null);
        blocks.add(new BlockAndValidity(this, b86, true, false, b86.getHash(), chainHeadHeight + 31, "b86"));

        NewBlock b87 = createNextBlock(b84, chainHeadHeight + 31, out30, null);
        blocks.add(new BlockAndValidity(this, b87, true, false, b86.getHash(), chainHeadHeight + 31, "b87"));
        spendableOutputs.offer(b87.getCoinbaseOutput());

        NewBlock b88 = createNextBlock(b87, chainHeadHeight + 32, out31, null);
        blocks.add(new BlockAndValidity(this, b88, true, false, b88.getHash(), chainHeadHeight + 32, "b88"));
        ...
        blocks.add(new BlockAndValidity(this, b89, false, true, b88.getHash(), chainHeadHeight + 32, "b89"));
        ...
        int largeReorgLastHeight = chainHeadHeight + 33 + LARGE_REORG_SIZE + 1;
        {
            ...
            for (int i = 0; i < LARGE_REORG_SIZE; i++) {
                ...
                nextBlock.solve();
                blocks.add(new BlockAndValidity(this, nextBlock, true, false, nextBlock.getHash(), nextHeight++, "large reorg initial blocks " + i));
            ...
            for (int i = 0; i < LARGE_REORG_SIZE; i++) {
                ...
                blocks.add(new BlockAndValidity(this, reorgBase, true, false, nextBlock.getHash(), nextHeight - 1, "large reorg reorg block " + i));
            }
            reorgBase = createNextBlock(reorgBase, reorgBaseHeight, null, null);
            blocks.add(new BlockAndValidity(this, reorgBase, true, false, reorgBase.getHash(), reorgBaseHeight, "large reorg reorging block"));
            nextBlock = createNextBlock(nextBlock, nextHeight, null, null);
            blocks.add(new BlockAndValidity(this, nextBlock, true, false, reorgBase.getHash(), nextHeight++, "large reorg second reorg initial"));
            spendableOutputs.offer(nextBlock.getCoinbaseOutput());
            nextBlock = createNextBlock(nextBlock, nextHeight, null, null);
            spendableOutputs.poll();
            blocks.add(new BlockAndValidity(this, nextBlock, true, false, nextBlock.getHash(), nextHeight++, "large reorg second reorg"));
            spendableOutputs.offer(nextBlock.getCoinbaseOutput());
        ...
        blocks.add(new BlockAndValidity(this, b1001, true, false, b1001.getHash(), largeReorgLastHeight + 1, "b1001"));
        ...
        if (runExpensiveTests) {
            ...
            for (blockCountAfter1001 = 0; blockCountAfter1001 < TRANSACTION_CREATION_BLOCKS; blockCountAfter1001++) {
                ...
                block.solve();
                blocks.add(new BlockAndValidity(this, block, true, false, block.getHash(), nextHeight - 1,
            ...
            for (int i = 0; i < blockCountAfter1001; i++) {
                NewBlock block = createNextBlock(lastBlock, nextHeight++, null, null);
                blocks.add(new BlockAndValidity(this, block, true, false, firstHash, height, "post-b1001 empty reorg block " + i + "/" + blockCountAfter1001));
                lastBlock = block;
            }
            ...
            b1002.solve();
            blocks.add(new BlockAndValidity(this, b1002, false, true, firstHash, height, "b1002"));

            // Now actually reorg
            NewBlock b1003 = createNextBlock(lastBlock, nextHeight, null, null);
            blocks.add(new BlockAndValidity(this, b1003, true, false, b1003.getHash(), nextHeight, "b1003"));
            ...
            b1004.solve();
            blocks.add(new BlockAndValidity(this, b1004, false, true, b1003.getHash(), nextHeight, "b1004"));
...
class BlockAndValidity extends Rule {
    ...
    FullBlockTestGenerator generator;

    public BlockAndValidity(FullBlockTestGenerator generator, Block block, boolean connects, boolean throwsException, Sha256Hash hashChainTipAfterBlock, int heightAfterBlock, String blockName) {
        super(blockName);
        ...
        generator.hashHeaderMap.put(block.getHash(), block.cloneAsHeader());

        // Double-check that we are always marking any given block at the same height
        Integer height = generator.blockToHeightMap.get(hashChainTipAfterBlock);
        if (height != null)
            checkState(height == heightAfterBlock);
        else
            generator.blockToHeightMap.put(hashChainTipAfterBlock, heightAfterBlock);
    }

    public BlockAndValidity(FullBlockTestGenerator generator, NewBlock block, boolean connects, boolean throwsException, Sha256Hash hashChainTipAfterBlock, int heightAfterBlock, String blockName) {
        this(generator, block.block, connects, throwsException, hashChainTipAfterBlock, heightAfterBlock, blockName);
        generator.coinbaseBlockMap.put(block.getCoinbaseOutput().outpoint.getHash(), block.getHash());
        Integer blockHeight = generator.blockToHeightMap.get(block.block.getPrevBlockHash());
        if (blockHeight != null) {
            blockHeight++;
            for (Transaction t : block.block.getTransactions())
                for (TransactionInput in : t.getInputs()) {
                    Sha256Hash blockSpendingHash = generator.coinbaseBlockMap.get(in.getOutpoint().getHash());
                    checkState(blockSpendingHash == null || generator.blockToHeightMap.get(blockSpendingHash) == null ||
                            generator.blockToHeightMap.get(blockSpendingHash) == blockHeight - generator.params.getSpendableCoinbaseDepth());
                }
        }
    }
